 ...
 * @author  Wesley Kerr
 */
public class InitialGlobalPanel extends JPanel {
    
    
    /** Creates a new instance of DisplayPanel */
    public InitialGlobalPanel() {
        super(true);
        init();
    }
    ...
    public void paintRobots(Graphics2D g, int size, Calculator c) {
        ...
        double Avy = -c.globalAvy;
        double Bvy = -c.globalBvy;
        
        g.setColor(Color.blue);
        g.fillOval((int) (size*c.globalAx)-3, (int) (size*Ay)-3, 6, 6);
        g.drawLine((int) (c.globalAx*size), (int) (Ay*size), (int) ((c.globalAx+c.globalAvx)*size), (int) ((Ay+Avy)*size));
        
        g.setColor(Color.red);
        g.fillOval((int) (size*c.globalBx)-3, (int) (size*By)-3, 6, 6);
        g.drawLine((int) (c.globalBx*size), (int) (By*size), (int) ((c.globalBx+c.globalBvx)*size), (int) ((By+Bvy)*size));
    }
    ...
    public void paintMomentum(Graphics2D g, Calculator c) {
        ...
        double mx = c.globalAvx + c.globalBvx;
        double my = c.globalAvy + c.globalBvy;
        ...
        g.setColor(Color.black);
        g.drawString("Avx: " + nf.format(c.globalAvx), getWidth()-80, 10);
        g.drawString("Avy: " + nf.format(c.globalAvy), getWidth()-80, 25);
        g.drawString("Bvx: " + nf.format(c.globalBvx), getWidth()-80, 60);
        g.drawString("Bvy: " + nf.format(c.globalBvy), getWidth()-80, 75);
